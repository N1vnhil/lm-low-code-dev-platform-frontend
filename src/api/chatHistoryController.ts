...
/** 此处后端没有提供注释 POST /chatHistory */
export async function adminListAllChatHistoryByPage(
  body: API.ChatHistoryQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.ResponsePageChatHistory>('/chatHistory', {
    method: 'POST',
    headers: {
...
/** 此处后端没有提供注释 POST /chatHistory/app/${param0} */
export async function listAppChatHistory(
  ...
  return request<API.ResponsePageChatHistory>(`/chatHistory/app/${param0}`, {
    method: 'POST',
    params: {
